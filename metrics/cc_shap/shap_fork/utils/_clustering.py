"""Clustering utilities for shap_fork.

Adapted from CC-SHAP shap/utils/_clustering.py with numba @jit removed.
"""
...
def xgboost_distances_r2(X, y, learning_rate=0.6, early_stopping_rounds=2, subsample=1, max_estimators=10000, random_state=0):
    """Compute redundancy distances scaled from 0-1 among all features in X relative to the label y."""
    import xgboost
    import sklearn.model_selection

    # pick our train/test split
